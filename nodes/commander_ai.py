...
# ========== Config ==========
CHANNEL_NAME = "commander-1-channel"
LOOP_INTERVAL_SEC = 10
OLLAMA_MODEL = "mistral"  # Must match the model name loaded in `ollama run mistral`
...
def query_ollama(prompt):
    try:
        ...
        print(f"[COMMANDER AI] ⚠️ Ollama query failed: {e}")
        return ""
    ...
    try:
        while True:
            ...
            if decision_line in valid_cmds:
                ...
                print(f"[COMMANDER AI] ❌ Ignored output: '{decision_line}'")
